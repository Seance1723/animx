...
export function run() {
  try {
    console.log('[Tests] Running AnimX v3.40.0 Final Stable Sign-Off verification...');
    ...
    if (fs.existsSync(pkgPath)) {
      ...
      assert.strictEqual(pkg.version, '3.40.0', 'package.json version must be 3.40.0');
    ...
    assert.strictEqual(signoffResult.stableSignoff.version, '3.40.0', 'signoff version must be 3.40.0');
