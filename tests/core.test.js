...
export function run() {
  try {
    assert.strictEqual(AnimX.version, '3.27.0', 'Version should match package');
    ...
    // v3.27.0 Advanced Button & Micro-Interactions Tests
