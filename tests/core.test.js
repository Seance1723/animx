...
export function run() {
  try {
    assert.strictEqual(AnimX.version, '3.22.0', 'Version should match package');
    ...
    // v3.22.0 Advanced Button & Micro-Interactions Tests
