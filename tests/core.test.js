...
export function run() {
  try {
    assert.strictEqual(AnimX.version, '3.25.0', 'Version should match package');
    ...
    // v3.25.0 Advanced Button & Micro-Interactions Tests
