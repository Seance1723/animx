...
export async function run() {
  try {
    ...
    // Check version
    assert.strictEqual(AnimX.build.version, '3.21.0', 'AnimX version should be 3.21.0');
    assert.strictEqual(AnimX.build.versionInfo().version, '3.21.0', 'versionInfo should be 3.21.0');
    assert.strictEqual(AnimX.build.versionInfo().release, 'Advanced Media Reveal, Image Masking, Video Motion, and Gallery Effects', 'release name should match');
    ...
    assert.strictEqual(state.version, '3.21.0', 'Project state should default to 3.21.0');
    ...
    assert.strictEqual(pkgObj.animxVersion, '3.21.0', 'Package version should match animx version');
    ...
    // v3.21.0 Pattern Library Integration
    ...
    assert.strictEqual(deliveryKit.version, '3.21.0', 'Delivery Kit should include version 3.21.0');
    ...
    // v3.21.0 Preset Pack & Recipe Tests
    ...
    // v3.21.0 Scene Validation Tests
    ...
    const validSceneStr = JSON.stringify({ schema: "animx-timeline-scene", schemaVersion: "1.0", animxVersion: "3.21.0", sceneId: "test-scene", name: "Test", tracks: [], steps: [] });
