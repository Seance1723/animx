...
export async function run() {
  try {
    ...
    // Check version
    assert.strictEqual(AnimX.build.version, '3.10.0', 'AnimX version should be 3.10.0');
    assert.strictEqual(AnimX.build.versionInfo().version, '3.10.0', 'versionInfo should be 3.10.0');
    assert.strictEqual(AnimX.build.versionInfo().release, 'Studio Final UX Polish and Public Studio Release', 'release name should match');
    ...
    assert.strictEqual(state.version, '3.10.0', 'Project state should default to 3.10.0');
    ...
    assert.strictEqual(pkgObj.animxVersion, '3.10.0', 'Package version should match animx version');
    ...
    assert.strictEqual(deliveryKit.version, '3.10.0', 'Delivery Kit should include version 3.10.0');
    ...
    // v3.10.0 Preset Pack & Recipe Tests
    ...
    // v3.10.0 Scene Validation Tests
    ...
    const validSceneStr = JSON.stringify({ schema: "animx-timeline-scene", schemaVersion: "1.0", animxVersion: "3.10.0", sceneId: "test-scene", name: "Test", tracks: [], steps: [] });
