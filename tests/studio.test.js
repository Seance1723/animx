...
export async function run() {
  try {
    ...
    assert.strictEqual(AnimX.versionInfo().release, 'Demo Website UX Rebuild, React Mini-Site, Journey Landing, Playground Builder, and Documentation Portal', 'release name should match');
