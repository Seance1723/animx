...
export async function run() {
  try {
    ...
    assert.strictEqual(AnimX.versionInfo().version, '3.42.0', 'versionInfo should be 3.42.0');
    assert.strictEqual(AnimX.versionInfo().release, 'Advanced Text Reveal and Split Animation Pack', 'release name should match');
