...
## ✨ Features
- **v3.13.0**: Animation Runtime Validation, Performance Hardening, and Demo Verification.
- **v3.12.0**: Complete Animation Coverage Matrix and Missing Effects Completion.
