...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.16\.0/g, '3.17.0');
    content = content.replace(/Motion State Manager, Trigger Orchestration, and Conditional Animation Rules/g, 'Advanced Scroll Storytelling, Responsive Motion Breakpoints, and Viewport Scene Packs');
