...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.17\.0/g, '3.18.0');
    content = content.replace(/Advanced Scroll Storytelling, Responsive Motion Breakpoints, and Viewport Scene Packs/g, 'Advanced 3D Motion, Spatial Effects, and Depth Interaction Packs');
