...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.18\.0/g, '3.19.0');
    content = content.replace(/Advanced 3D Motion, Spatial Effects, and Depth Interaction Packs/g, 'Advanced Physics Motion, Easing Curve Studio, and Natural Interaction Dynamics');
