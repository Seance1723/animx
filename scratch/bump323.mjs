...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.22\.0/g, '3.23.0');
    content = content.replace(/Advanced Button, Link, Navigation, and Micro-Interaction Packs/g, 'Advanced Card, Grid, List, Table, and Dashboard Motion Packs');
