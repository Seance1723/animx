...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.21\.0/g, '3.22.0');
    content = content.replace(/Advanced Media Reveal, Image Masking, Video Motion, and Gallery Effects/g, 'Advanced Button, Link, Navigation, and Micro-Interaction Packs');
