...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.24\.0/g, '3.25.0');
    content = content.replace(/Advanced Form, Modal, Drawer, Toast, Tooltip, and UI Feedback Motion/g, 'Advanced Background, Decorative Motion, Ambient Effects, and Visual Atmosphere Packs');
