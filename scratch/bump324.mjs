...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.23\.0/g, '3.24.0');
    content = content.replace(/Advanced Card, Grid, List, Table, and Dashboard Motion Packs/g, 'Advanced Form, Modal, Drawer, Toast, Tooltip, and UI Feedback Motion');
