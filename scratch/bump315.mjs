...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.14\.0/g, '3.15.0');
    content = content.replace(/Real-World Animation Pattern Library and Industry Demo Packs/g, 'Animation Composer, Effect Chaining, and Variant Builder');
