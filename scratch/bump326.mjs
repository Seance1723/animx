...
const files = [
  ...
  'src/js/state/state-api.js',
  'src/js/scroll-story/scroll-story-api.js',
  'src/js/scroll-story/scroll-story-runner.js',
  'src/js/scroll-story/responsive-motion-parser.js',
  'src/js/scroll-story/viewport-scene-packs.js',
  'src/js/spatial/spatial-api.js',
  'src/js/spatial/pointer-depth.js',
  'src/js/three-d/three-d-api.js',
  'src/js/three-d/three-d-presets.js',
  'src/js/physics/physics-api.js',
  'src/js/easing/easing-api.js',
  'src/js/text/advanced-text-api.js',
  'src/js/media/media-api.js',
  'src/js/interactions/advanced-interaction-api.js',
  'src/js/data-ui/data-ui-api.js',
  'src/js/feedback/feedback-api.js',
  'src/js/backgrounds/background-api.js',
  'demo/studio.html',
  'demo/index.html',
...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.25\.0/g, '3.26.0');
    content = content.replace(/Advanced Background, Decorative Motion, Ambient Effects, and Visual Atmosphere Packs/g, 'Advanced SVG, Icon, Logo, Path, and Infographic Motion Packs');
