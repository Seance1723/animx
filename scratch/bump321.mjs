...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.20\.0/g, '3.21.0');
    content = content.replace(/Advanced Creative Text Reveal, Rolling Typography, and Scroll Type Studio/g, 'Advanced Media Reveal, Image Masking, Video Motion, and Gallery Effects');
