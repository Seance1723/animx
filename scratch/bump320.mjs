...
files.forEach(f => {
  ...
  if (fs.existsSync(p)) {
    ...
    content = content.replace(/3\.19\.0/g, '3.20.0');
    content = content.replace(/Advanced Physics Motion, Easing Curve Studio, and Natural Interaction Dynamics/g, 'Advanced Creative Text Reveal, Rolling Typography, and Scroll Type Studio');
